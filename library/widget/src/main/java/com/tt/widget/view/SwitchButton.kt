...
class SwitchButton @JvmOverloads constructor(
    ...
    private val aspectRatio: Float = 0.6f
    ...
    /** 开启状态背景色 */
    private var accentColor: Int = Color.parseColor("#C640FF")

    /** 开启状态按钮描边色 */
    private var primaryDarkColor: Int = Color.parseColor("#E7659D")

    /** 关闭状态描边色 */
    private var offColor: Int = Color.parseColor("#E2E2E2")

    /** 关闭状态按钮描边色 */
    private var offDarkColor: Int = Color.parseColor("#E2E2E2")
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isEnabled) {
            paint.color = Color.parseColor("#E2E2E2")
        } else {
