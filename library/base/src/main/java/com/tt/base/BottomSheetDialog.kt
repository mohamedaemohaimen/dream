...
open class BottomSheetDialog @JvmOverloads constructor(
    context: Context, themeResId: Int = R.style.BaseDialogTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uiOptions: Int =
            (decorView.systemUiVisibility or View.SYSTEM_UI_FLAG_HIDE_NAVIGATION or View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY)
