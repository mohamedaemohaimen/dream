...
import com.tt.widget.view.PressAlphaTextView
...
class TitleBarStyle : LightBarStyle() {
    ...
    override fun getBackButtonDrawable(context: Context): Drawable? {
        return ContextCompat.getDrawable(context, R.drawable.arrow_back_ic)
    }
    ...
    override fun getRightTitleSize(context: Context): Float {
        return context.resources.getDimension(R.dimen.sp_12)
    }
