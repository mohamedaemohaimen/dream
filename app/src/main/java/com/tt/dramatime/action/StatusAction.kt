...
interface StatusAction {
     ...
     */
    fun showEmpty() {
        showLayout(R.drawable.no_data_ic, R.string.status_layout_no_data, null)
    }
        ...
        getStatusLayout()?.let {
            ...
            if (manager != null) {
                ...
                if (info == null || !info.isConnected) {
                    showLayout(R.drawable.network_error_ic, R.string.status_layout_error_network, listener)
                    return
                }
            }
            showLayout(R.drawable.network_error_ic, R.string.status_layout_error_request, listener)
        }
    }
