package com.tt.dramatime.http.glide
...
class GlideConfig : AppGlideModule() {
    ...
    companion object {
        ...
        /** 本地图片缓存文件最大值 */
        private const val IMAGE_DISK_CACHE_MAX_SIZE: Int = 800 * 1024 * 1024
    }
    ...
    override fun applyOptions(context: Context, builder: GlideBuilder) {
        ...
        builder.setDefaultRequestOptions(
            RequestOptions()
                ...
                .placeholder(R.color.color_EDEDED) // 设置默认加载中占位图
                .error(R.color.color_EDEDED) // 设置默认加载出错占位图
        )
    }
