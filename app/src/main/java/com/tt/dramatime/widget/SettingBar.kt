...
class SettingBar @JvmOverloads constructor(
    ...
    private val rightImageView: ImageView = ImageView(getContext())
    ...
    init {
        ...
        rightImageView.layoutParams = rightParams

        val lineViewParams = LayoutParams(LayoutParams.MATCH_PARENT, 1, Gravity.BOTTOM)
        lineViewParams.marginStart = resources.getDimension(R.dimen.dp_16).toInt()
        lineViewParams.marginEnd = resources.getDimension(R.dimen.dp_16).toInt()
        ...
        leftView.setLineSpacing(
            resources.getDimension(R.dimen.dp_5), leftView.lineSpacingMultiplier
        )
        rightView.setLineSpacing(
            resources.getDimension(R.dimen.dp_5), rightView.lineSpacingMultiplier
        )
        ...
        if (array.hasValue(R.styleable.SettingBar_bar_leftPadding)) {
            leftView.setPaddingRelative(
                array.getDimensionPixelSize(
                    R.styleable.SettingBar_bar_leftPadding, 0
                ),
                resources.getDimension(R.dimen.dp_12).toInt(),
                resources.getDimension(R.dimen.dp_16).toInt(),
                resources.getDimension(R.dimen.dp_12).toInt()
        ...
        setRightDrawablePadding(
            ...
            else resources.getDimension(R.dimen.dp_16).toInt()
        )
        ...
        setLeftTextBold(array.getBoolean(R.styleable.SettingBar_bar_leftTextBold, false))

        setRightTextSize(
            TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(
                R.styleable.SettingBar_bar_rightTextSize,
                resources.getDimension(R.dimen.sp_13).toInt()
            ).toFloat()
        )
        ...
        mainLayout.addView(rightImageView)
    ...
    fun setLeftDrawable(drawable: Drawable?): SettingBar = apply {
        if (LanguageManager.isArabicLocale(context)) {
            leftView.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null)
        } else {
    ...
    fun setRightDrawable(drawable: Drawable?): SettingBar = apply {
        rightImageView.setPaddingRelative(
            0,
            resources.getDimension(R.dimen.dp_12).toInt(),
     ...
     * 设置左边的文字是否加粗
     */
    fun setLeftTextBold(bold: Boolean): SettingBar = apply {
        leftView.paint.isFakeBoldText = bold
    }
