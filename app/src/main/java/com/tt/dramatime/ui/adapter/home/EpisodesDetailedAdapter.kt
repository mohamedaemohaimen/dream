...
import com.tt.dramatime.databinding.EpisodesDetailedItemBinding
 ...
 * </pre>
 */
class EpisodesDetailedAdapter(dataList: MutableList<MovieListBean>) :
    BaseVBQuickAdapter<EpisodesDetailedItemBinding, MovieListBean>(dataList) {


    override fun onBindViewHolder(
        holder: BaseVBHolder<EpisodesDetailedItemBinding>, position: Int, item: MovieListBean?
    ) {
        item?.apply {
