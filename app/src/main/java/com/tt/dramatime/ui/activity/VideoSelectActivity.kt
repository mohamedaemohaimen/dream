...
import com.tt.dramatime.ui.activity.CameraActivity.OnCameraListener
import com.tt.dramatime.ui.adapter.VideoSelectAdapter
import com.tt.dramatime.ui.dialog.AlbumDialog
import com.tt.dramatime.ui.dialog.AlbumDialog.AlbumInfo
 ...
 *    desc   : 选择视频
 */
class VideoSelectActivity : AppActivity(), com.tt.dramatime.action.StatusAction, Runnable, BaseAdapter.OnItemClickListener,
    ...
    companion object {
        ...
        @Log
        @Permissions(Permission.READ_MEDIA_VIDEO)
